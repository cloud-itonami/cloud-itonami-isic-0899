# Operator Quickstart — Other Mining and Quarrying Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0899** (`cloud-itonami-isic-0899`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0899.git
cd cloud-itonami-isic-0899
```
...
- Blueprint governor key: `quarry-site-governor`
